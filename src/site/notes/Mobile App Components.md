...
- Need some equivalent to FAWG
	- QA: 2
	- UX: 1
	- PdM: 1
	- Dev: 4 (includes architects)
	- API: 1
	- PgM: 1
	- EL: 1
	- PMM: 1
- Distribute out some existing experts to some experience teams
- Need for coordination across teams for release management
...
3. 
4. Home / Discovery tab
5. Family History Activities
6. Memories / Discovery
7. Relatives Around Me / Relatives at Events
8. Chat / Contacts
9. 
10. Tree pedigrees, persons, recents / tree operations
11. Hints / tasks / record attach
12. My Contributions
13. 
14. Search
15. 
16. Temple / Ordinances Ready
17. Guided Tree Building
18. Family Groups
19. Help
